...
import com.sml.sz.common.servlet.ValidateCodeServlet;
import com.sml.sz.common.web.BaseController;
import com.sml.sz.config.Global;
import com.sml.sz.sys.security.FormAuthenticationFilter;
...
public class LoginController extends BaseController{
	 ...
	 * @throws IOException 
	 */
	@RequestMapping(value = "${adminPath}/code")
...
//		if(ValidateCodeServlet.validate(request, code)){
//			message = "验证码输入错误";
//		}
...
//		try {
//			byte[] bytes = com.sml.sz.FileUtils.readFileToByteArray(
//					com.sml.sz.FileUtils.getFile("c:\\sxt.dmp"));
