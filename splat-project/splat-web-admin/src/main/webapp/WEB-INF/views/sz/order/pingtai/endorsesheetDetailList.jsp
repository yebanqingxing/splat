...
$(function(){
	...
	function page(n,s){
		...
		var pageSize=s;
		$.post(
				'${ctx}/order/ping/endorsesheetDetail/list1?number='+Math.random(),
...
<div class="query">
	...
	<div class="queryinter">
		...
		<select id="currentStatus" name="currentStatus"  class="querycode">
			...
			<option value="2">等待改签</option>
			<option value="4">改签完成</option>
		...
		<table border="0">
		  <tr>
		    <td id="td" class="tableclcik"><a href="javascript:;" onclick="searchAll(this);">全部</a></td>
		    	<td><a href="javascript:;" onclick="findCurrentStatus(this,'1')">审核改签(${currentStatusList['1']})</a></td>
		    	<td><a href="javascript:;" onclick="findPayStatus(this,'1')">等待支付(${payStatusCountList['1'] })</a></td>
	    		<td><a href="javascript:;" onclick="findCurrentStatus(this,'2')">等待改签(${currentStatusList['2']})</a></td> 
	    		<td><a href="javascript:;" onclick="findCurrentStatus(this,'4');">改签完成(${currentStatusList['4']})</a></td> 
	    		<td><a href="javascript:;" onclick="findCurrentStatus(this,'3')">审核拒绝(${currentStatusList['3']})</a></td> 
	    		<td><a href="javascript:;" onclick="findOrderStatus(this,'3')">异常订单(${statusCount['3'] })</td> 
		    	<td><a href="javascript:;" onclick="findOrderStatus(this,'2')">取消改签(${statusCount['2'] })</a></td>
		  </tr>
		</table>
	</div>
	<!-- 数据展示 -->
