...
<!-- 				<button class="addquery butwid">操作历史</button> -->
				<a href="${ctx }/refundsheetdetail/ping/refundsheetDetail/pingrefundsheetDetail?refundsheetNo=${refundsheetDetail.refundsheetNo}"><button class="addquery butwid">详情信息</button></a>
			</div>
		</div>
	</div>	
</c:forEach>
