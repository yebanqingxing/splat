...
<!-- 				<button class="addquery butwid">操作历史</button> -->
				<a href="${ctx }/order/ping/endorsesheetDetail/findpingEndorsesheetDetail?endorsesheetNo=${endorsesheetDetail.endorsesheetNo }"><button type="button" class="addquery butwid">详情信息</button></a>
			</div>
		</div>
	</div>
</c:forEach>
