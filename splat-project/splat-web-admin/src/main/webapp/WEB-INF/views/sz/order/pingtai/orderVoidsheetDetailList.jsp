...
$(function(){
	...
	function page(n,s){
		...
		var pageSize=s;
		$.post(
				'${ctx}/order/ping/voidsheetDetail/list?number='+Math.random(),
	...
	<div class="orderretreat">
		<table border="0">
		  <tr>
    		...
    		<td><a href="javascript:;" onclick="findOrderStatus(this,'2')">异常订单(${statusCountList['2'] })</a></td>
    		<td><a href="javascript:;" onclick="findCurrentStatus(this,'3');">废票拒绝(${currentStatusList['3'] })</a></td>
    		<td><a href="javascript:;" onclick="findOrderStatus(this,'2')">取消废票(${statusCountList['2'] })</a></td>
    		<td><a href="javascript:;" onclick="findPayStatus(this,'1');">退款订单(${payStatusCountList['1'] })</a></td>
		  </tr>
		</table>
	</div>
