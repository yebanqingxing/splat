		...
		<div class="pnr-content-left">
			<div class="order">
				<div class="orderlist">
					...
					<ul>
						<li><a href="<%=request.getContextPath()%>/a/order/ping/tbTicketorderDetail/list" target="rightFrame" class="clickulli">国际订单查询</a></li>
						<li><a href="<%=request.getContextPath()%>/a/order/ping/refundsheetDetail" target="rightFrame">国际退票订单</a></li>
						<li><a href="<%=request.getContextPath()%>/a/order/ping/voidsheetDetail" target="rightFrame">国际废票订单</a></li>
						<li><a href="<%=request.getContextPath()%>/a/order/ping/endorsesheetDetail/list1" target="rightFrame">国际改签订单</a></li>
					</ul>
				</div>
				<div class="orderlist">
