...
<body>
	...
	<div class="effect-head clear" style="margin-top:20px;margin-bottom:30px;">
		<p>部门<shiro:hasPermission name="sys:office:edit">${not empty office.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:office:edit">查看</shiro:lacksPermission>：</p>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="office" name="parent.id" value="${office.parent.id}" labelName="parentName" labelValue="${office.parent.name}"
					title="单位" url="/sys/office/treeData?platType=A" cssClass="required" notAllowSelectParent="false"/>
				<font color="red">*</font>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			...
			<%-- </shiro:hasPermission> --%>
			<input id="btnCancel" class="btn default" type="button" value="返 回" onclick="window.location.href = '${ctx}/sys/office/list?platType=A'"/>
		</div>
	</form:form>
</body>
</html>