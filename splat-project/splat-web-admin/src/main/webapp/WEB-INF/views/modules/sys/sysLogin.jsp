...
<script type="text/javascript" src="${ctxStatic}/js/banner.js?<%=new Date().getTime()%>"></script>
<script>
	...
	<div class="home">
		...
		<div class="sign">
			<div class="sign-main clear">
				...
				<div class="form-user">
					<input type="text" value="splat" name="username" id="username" class="sign-input">
				...
				<div class="form-code">
					<%-- <input type="text" value=<%=(String)session.getAttribute("code")%>/> --%>
					<input type="text" value="" name="code" id="code" maxlength="4" class="sign-code" onblur="check()">
					<img src="${ctx}/code" alt="验证码" id="codeImg" onclick="changeImg();" >
					<!-- <input type="text" onClick="createCode()" readonly="readonly" id="checkCode"/> -->
					<%-- <img src="${ctxStatic}/images/code.jpg"> --%> 
				</div>
