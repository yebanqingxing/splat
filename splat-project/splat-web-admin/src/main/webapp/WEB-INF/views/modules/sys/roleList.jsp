...
<head>
	...
	<script type="text/javascript">
		function addRole(){
			window.location.href="${ctx}/sys/role/form";
			return false;
		}
		function page(n,s){
			if(n) $("#pageNo").val(n);
...
<body>
	...
	<div class="query">
		<form:form id="searchForm" modelAttribute="role" action="${ctx}/sys/role/list" method="post">
			<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
			<input id="pageSize" name="pageSize" type="hidden" value="10"/>
			<span class="query-span fl" style="width: 90px; display: inline-block;">角色名称：</span>
			<form:input path = "name" htmlEscape="false" maxlength="50" class="querycode fl"/>
			
			<span class="query-span fl">状态信息：</span>
			<form:select path="useable"  class="selectquery fl" style="margin-right: 20px; margin-top:0;" >
