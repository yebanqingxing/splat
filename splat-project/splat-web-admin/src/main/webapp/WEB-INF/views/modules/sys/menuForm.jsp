...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label" style="padding-top:0px;">可见:</label>
			<div class="controls">
		...
		<div class = "control-group">
			...
			<form:select path="platType" class="controls">
				<form:option value=""    selected = "${role.platType==null||role.platType=='undefined'?true:''}">请选择</form:option>
		...
		<div class="form-actions" style="margin-top: 10px;">
			<shiro:hasPermission name="sys:menu:edit"><input id="btnSubmit" class="btn green" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
