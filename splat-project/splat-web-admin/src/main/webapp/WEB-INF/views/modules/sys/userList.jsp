		...
		<ul class="ul-form">
			...
			<li>
				...
				<sys:treeselect id="office" name="office.id" value="${office.id}" 
								labelName="office.name" labelValue="${office.name}" 
								title="部门" url="/sys/office/treeData?platType=A" cssClass="input-small" allowClear="true" notAllowSelectParent="true"/>
			</li> 
		...
		<c:forEach items="${page.list}" var="user">
			<tr>
				...
				<shiro:hasPermission name="sys:user:edit">
					<td>
						<a href="${ctx}/sys/user/detial?id=${user.id}" class="btn btn-xs red">详情 <i class="fa fa-edit"></i></a>
