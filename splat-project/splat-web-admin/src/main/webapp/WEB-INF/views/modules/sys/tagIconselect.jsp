...
<head>
    ...
    <style type="text/css">
        ...
        .tab-content .span4{width:33%;margin:0 auto;}
        .fa-item {
padding: 10px 10px 10px 30px;
}
	.margin-bottom-20{overflow: hidden;}
	div.fa-item.span4.active {
		background: #FFF;
	}
...
<link href="${ctxStatic}/bootstrap/assets/global/css/components.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript">
	    $(document).ready(function(){
	    	...
	    	$("#icons-content div.fa-item").click(function(){
	    		$("#icons-content div.fa-item").removeClass("active");
	    		//$("#icons-content div.fa i").removeClass("icon-white");
	    		$(this).addClass("active");
	    		//$(this).children("i").addClass("icon-white");
	    		$("#icon").val($("i",this).attr("class"));
	    	});
	    	$("#icons-content div.fa-item").each(function(){
	    		if ($("i",this).attr("class")=="${value}"){
	    			$(this).click();
	    		}
	    	});
	    	$("#icons-content div.fa-item").dblclick(function(){
	    		top.$.jBox.getBox().find("button[value='ok']").trigger("click");
	    	});
	    });
    </script>
...
<div id="icons-content" class="page-content-wrapper">
		<div class="page-content" style="margin: 0 auto!important;padding-top: 0px!important;">
						<div class="tab-content" style="margin-top: 0px;padding-top: 0px;">
							<div class="tab-pane active fontawesome-demo" id="tab_1_1">
								
								<h3 style="text-indent: 20px;background-color: #26A69A;color:#fff;margin-bottom: 0;">常用图标</h3>
								<div class="margin-bottom-20 alert alert-info">
									<div class="fa-item span4">
								...
								<h3 style="text-indent: 20px;background-color: #26A69A;color:#fff;margin-bottom: 0;">Web 应用图标</h3>
								<div class="margin-bottom-20 alert alert-error">
									<div class="fa-item span4">
								...
								<h3 style="text-indent: 20px;background-color: #26A69A;color:#fff;margin-bottom: 0;">文件类型图标</h3>
								...
								<h3 style="text-indent: 20px;background-color: #26A69A;color:#fff;margin-bottom: 0;">微调图标</h3>
								<div class="margin-bottom-20 alert alert-danger">
									<div class="fa-item span4">
										<i class="fa fa-circle-o-notch"></i> fa-circle-o-notch
									</div>
								...
								<h3 style="text-indent: 20px;background-color: #26A69A;color:#fff;margin-bottom: 0;">表单常用图标</h3>
								<div class="margin-bottom-20 alert alert-success">
									<div class="fa-item span4">
										<i class="fa fa-check-square"></i> fa-check-square
									</div>
									<div class="fa-item span4">
								...
								<h3 style="text-indent: 20px;background-color: #26A69A;color:#fff;margin-bottom: 0;">货币图标</h3>
								<div class="margin-bottom-20 alert alert-info">
									<div class="fa-item span4">
								...
								<h3 style="text-indent: 20px;background-color: #26A69A;color:#fff;margin-bottom: 0;">文本编辑器图标</h3>
								<div class="margin-bottom-20 alert alert-danger">
									<div class="fa-item span4">
								...
								<h3 style="text-indent: 20px;background-color: #26A69A;color:#fff;margin-bottom: 0;">指示方向的图标</h3>
								<div class="margin-bottom-20 alert alert-success">
									<div class="fa-item span4">
								...
								<h3 style="text-indent: 20px;background-color: #26A69A;color:#fff;margin-bottom: 0;">视频播放器图标</h3>
								<div class="margin-bottom-20 alert alert-error">
									<div class="fa-item span4">
										<i class="fa fa-arrows-alt"></i> fa-arrows-alt
									</div>
								...
								<h3 style="text-indent: 20px;background-color: #26A69A;color:#fff;margin-bottom: 0;">常用商标图标</h3>
									<div class="margin-bottom-20 alert alert-success">
										<div class="fa-item span4">
									...
									<h3 style="text-indent: 20px;background-color: #26A69A;color:#fff;margin-bottom: 0;">医疗图标</h3>
									<div class="margin-bottom-20 alert alert-danger" style="margin-bottom: 29px !important;">
										<div class="fa-item span4">
