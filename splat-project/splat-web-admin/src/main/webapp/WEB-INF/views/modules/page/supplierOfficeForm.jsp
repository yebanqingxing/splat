...
<body>
	<div class="effect-head clear" style="margin-top:31px;margin-bottom:4px;">
		<p>供应商<shiro:hasPermission name="sys:office:edit">${not empty office.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:office:edit">查看</shiro:lacksPermission>：</p>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<%-- <div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="office" name="parent.id" value="${office.parent.id}" labelName="parentName" labelValue="${office.parent.name}"
					title="单位" url="/sys/office/treeData?edit=true&platType=S" cssClass="required" notAllowSelectParent="false"/>
			</div>
		</div> --%>
		<br />	
		<div class="control-group">
			...
			<div class="controls">
              	<form:input path="name" class="required"/><span style="color:red">*</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">联系人姓名:</label>
			<div class="controls">
				<form:input path="master" class="required"/><span style="color:red">*</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path = "address" class="required"/><span style="color:red">*</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="area" name="area.id" value="${office.area.id}" labelName="areaName" labelValue="${office.area.name}"
					title="区域" url="/sys/area/treeData" cssClass="required" notAllowSelectParent="false"/><span style="color:red">*</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			...
			<input id="btnCancel" class="btn default" type="button" value="返 回" onclick="window.location.href = '${ctx}/sys/office/supplierList?platType=S&type=1'"/>
		</div>
	</form:form>
</body>
</html>