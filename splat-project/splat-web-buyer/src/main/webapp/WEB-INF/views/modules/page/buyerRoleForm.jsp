...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/buyerSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<%-- <div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="office" name="office.id" value="${role.office.id}" labelName="office.name" labelValue="${role.office.name}"
					title="机构" url="/sys/office/treeData?platType=B&type=1" cssClass="required"/>
			</div>
		</div> --%>
		<div class="control-group">
		...
		<div class="form-actions">
			<%-- <c:if test="${(role.sysData eq fns:getDictValue('是', 'yes_no', '1') && fns:getUser().admin)||!(role.sysData eq fns:getDictValue('是', 'yes_no', '1'))}"> --%>
				...
				<%-- </shiro:hasPermission> --%>
			<%-- </c:if> --%>
			<a href = "${ctx}/sys/role/buyerList"><input id="btnCancel" class="btn default" type="button" value="返 回" /></a>
		</div>
	</form:form>
</body>
</html>