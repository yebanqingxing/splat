...
<body>
	...
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/test/testData/save" method="post" class="form-horizontal">
		...
		<div class="control-group" style="margin-top: 12px;padding-bottom: 2px;">
			<label class="control-label" style="margin-top:-2px;padding-top:0px;">性别：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="test:testData:edit"><input id="btnSubmit" class="btn green" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
