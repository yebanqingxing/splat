...
<body>
	...
	<form:form id="inputForm" modelAttribute="testDataMain" action="${ctx}/test/testDataMain/save" method="post" class="form-horizontal">
				...
				<div class="controls">
					<table id="contentTable" class="table table-bordered table-striped table-condensed flip-content">
						...
						<shiro:hasPermission name="test:testDataMain:edit"><tfoot>
							<tr>
							  <td colspan="4">
							      <a href="javascript:" onclick="addRow('#testDataChildList', testDataChildRowIdx, testDataChildTpl);testDataChildRowIdx = testDataChildRowIdx + 1;" class="btn btn-xs green">新增 <i class="fa fa-plus"></i></a>
							  </td>
						   </tr>
		...
		<div class="form-actions">
			<shiro:hasPermission name="test:testDataMain:edit"><input id="btnSubmit" class="btn green" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
