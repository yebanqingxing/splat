...
//				}
    ...
    public static ClientKeyStore loadClientKeyStore(String keyStorePath, String keyStorePass, String privateKeyPass){
    	try{
    		...
    		System.out.println("loadClientKeyFactory fail : "+e.getMessage());
    		return null;
    	}
    }
    ...
    public static TrustKeyStore loadTrustKeyStore(String keyStorePath, String keyStorePass){
    	try{
    		...
    		System.out.println("loadTrustCertFactory fail : "+e.getMessage());
    		return null;
    	}
    }
	...
	public static void main(String[] args) {
		/*String notify_url = "http://106.39.53.172/zhifubao-zf/notify_url.jsp";
		SimpleHttpParam simple=new SimpleHttpParam("https://mapi.alipay.com/gateway.do?_input_charset=utf-8");
		Map<String, Object> sParaTemp = new HashMap<String, Object>();
		sParaTemp.put("service", "distribute_royalty");
        sParaTemp.put("partner", "2088221312856899");
        sParaTemp.put("_input_charset", "utf-8");
        sParaTemp.put("trade_no", "2016032300001000170090292260");
		sParaTemp.put("out_trade_no", "100716032310006949");
		sParaTemp.put("out_bill_no", "1540292402000");
		sParaTemp.put("royalty_parameters", "cuijin2012@foxmail.com^1.0^测试");
		sParaTemp.put("royalty_type", "10");
		sParaTemp.put("notify_url", notify_url);
		SimpleHttpUtils http=new SimpleHttpUtils();
		  Map<String, Object> sPara = AliUtil.buildRequestPara(sParaTemp,"7agqxefiiuq0zqs4semw012aq20n5vy6","utf-8","MD5");
		  simple.setParameters(sPara);
