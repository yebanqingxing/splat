 ...
 * @version 2016-03-15
 */
public class RefundsheetAppendix extends DataEntity<RefundsheetAppendix> {
	
	private static final long serialVersionUID = 1L;
	private String refundsheetNo;		// 退票单号外键
	...
	public RefundsheetAppendix() {
		super();
	}

	public RefundsheetAppendix(String id){
		super(id);
	}

	@Length(min=0, max=36, message="退票单号外键长度必须介于 0 和 36 之间")
