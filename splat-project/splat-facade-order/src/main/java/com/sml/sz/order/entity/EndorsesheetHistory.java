 ...
 * @version 2016-03-15
 */
public class EndorsesheetHistory extends DataEntity<EndorsesheetHistory> {
	...
	public EndorsesheetHistory() {
		super();
	}

	public EndorsesheetHistory(String id){
		super(id);
	}
	...
	@Length(min=0, max=200, message="变化前数据长度必须介于 0 和 200 之间")
