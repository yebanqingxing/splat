 ...
 * @version 2016-03-15
 */
public class VoidsheetAppendix extends DataEntity<VoidsheetAppendix> {
	...
	private String operatorChannelId;		// 操作机构id
	private String orgnFileName;		// 原始文件名
	
	public VoidsheetAppendix() {
		super();
	}

	public VoidsheetAppendix(String id){
		super(id);
	}
	...
	@Length(min=0, max=25, message="操作机构id长度必须介于 0 和 25 之间")
