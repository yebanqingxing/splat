...
public class Pay {
	...
	public String buildPayUrlPost(Map<String, String> map) throws UnsupportedEncodingException {
		...
		String pc_ProductDesc = map.get("pc_ProductDesc");
		...
		html += "<input type='hidden' name='pc_ProductDesc' value='" + pc_ProductDesc + "'>" + "\r";
	...
	public String buildPayUrlGet(Map<String, String> map) throws UnsupportedEncodingException {
		...
		String url = "http://210.51.190.223:9083/pay-web-gateway/gateway_init.action";
		...
		url += "&pc_ProductDesc=" + URLEncoder.encode(pc_ProductDesc, "utf-8");
	...
	public String hmacRequest(Map<String, String> map) {
		...
		signStr.append("&pc_ProductDesc=").append(pc_ProductDesc);
