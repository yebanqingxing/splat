...
import com.sml.sz.common.persistence.BaseEntity;
...
/*
	*//**
	 ...
	 * @return 标准连接条件对象
	 *//*
	public static String dataScopeFilter(User user, String officeAlias, String userAlias,String platType) {
...
//							}
			...
			//平台过滤
			if(platType != null){
				sqlString.append("AND " + officeAlias + ".plat_type = " + platType );
			}
		}
		if (StringUtils.isNotBlank(sqlString.toString())){
			return " AND (" + sqlString.substring(4) + ")";
