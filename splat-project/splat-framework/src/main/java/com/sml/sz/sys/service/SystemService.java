...
import com.sml.sz.Encodes;
import com.sml.sz.MD5EncryptUtil;
import com.sml.sz.StringUtils;
import com.sml.sz.common.persistence.Page;
import com.sml.sz.common.security.Digests;
import com.sml.sz.common.security.shiro.session.SessionDAO;
import com.sml.sz.common.service.BaseService;
import com.sml.sz.common.service.ServiceException;
import com.sml.sz.config.Global;
import com.sml.sz.sys.dao.MenuDao;
...
//import com.sml.sz.sys.security.SystemAuthorizingRealm;
import com.sml.sz.sys.utils.LogUtils;
//import com.sml.sz.sys.utils.MD5Encrypt4SSO;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public void updatePasswordById(String id, String loginName, String newPassword) {
		...
		user.setPassword( MD5EncryptUtil.encryptMD5Code(newPassword));
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<Menu> findAllMenu(String platType){
		return UserUtils.getMenuList(platType);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		//sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://splat.com QQ:3121026417\r\n");
		//sb.append("\r\n--splat--splat--splat--splat--splat--splat--splat--splat--splat--splat--\r\n");
