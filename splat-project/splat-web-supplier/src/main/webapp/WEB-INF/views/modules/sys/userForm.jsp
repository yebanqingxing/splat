...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="company" name="office.id" value="${company.pId}"  labelName="officeName" labelValue="${company.name}" notAllowSelectRoot="true"
					title="所属部门" url="/sys/office/treeData" cssClass="required"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">角色:</label>
			<div class="controls">
                <sys:treeselect id="role" name="roleIdList" value="${role.id}"  labelName="role.name" labelValue="${role.name}"
