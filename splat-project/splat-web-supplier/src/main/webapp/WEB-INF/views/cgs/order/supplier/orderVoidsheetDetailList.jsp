...
$(function(){
	...
	function page(n,s){
		...
		var pageSize=s;
		$.post(
				'${ctx}/order/supplier/voidsheetDetail/list?number='+Math.random(),
	...
	//查找支付状态
	function findOrderStauts(obj,status){
		editClass(obj);
...
<body>
<div class="addpolicy">
	<img src="${ctxStatic}/order/images/orderwaste.png">
	<p>国际废票订单</p>
</div>
<!-- 总则编码 -->
<div class="query">
...
<input  type="hidden" name="hid_voidsheetStatus" value="" id="hid_voidsheetStatus"/>
		...
		<table border="0">
		  <tr>
		    <td id="td" class="tableclcik"><a href='javascript:;' onclick='searchAll();'>全部</a></td>
		    	<td><a href="javascript:;" onclick="findCurrentStatus(this,'1');">审核废票(${currentStatus['1'] })</a></td>
		    	<td><a href="javascript:;" onclick="findCurrentStatus(this,'6');">等待确认(${currentStatus['6'] })</a></td>
		    	<td><a href="javascript:;" onclick="findCurrentStatus(this,'2');">废票操作(${currentStatus['2'] })</a></td>
		    	<td><a href="javascript:;" onclick="findCurrentStatus(this,'5');">废票完成(${currentStatus['5'] })</a></td>
		    	<td><a href="javascript:;" onclick="findOrderStatus(this,'2');">异常订单(${statusCount['2'] })</a></td>
		    	<td><a href="javascript:;" onclick="findCurrentStatus(this,'3');">审核拒绝(${currentStatus['3'] })</a></td>
		    	<td><a href="javascript:;" onclick="findOrderStauts(this,'3')">废票取消(${statusCount['3'] })</a></td>
		  </tr>
		</table>
	</div>
