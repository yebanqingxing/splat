...
<!-- 				<button class="addquery butwid">操作历史</button> -->
				<a href="${ctx }/order/supplier/endorsesheetDetail/findEndorsesheetDetail?endorsesheetNo=${endorsesheetDetail.endorsesheetNo }"><button class="addquery butwid">详情信息</button></a>
			</div>
		</div>
	</div>
</c:forEach>
