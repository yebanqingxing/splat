...
<title>国际机票产品(供应商)</title>
<link rel="stylesheet" type="text/css" href="${ctxStatic}/order/css/style.css">
<link rel="stylesheet" type="text/css" href="${ctxStatic}/order/css/reset.css">
<link rel="stylesheet" type="text/css" href="${ctxStatic}/order/css/order.css">
<script type="text/javascript" src="${ctxStatic}/jquery/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="${ctxStatic}/order/js/order.js"></script>
</head>
<body>
	<!-- head -->
	<div class="head-mian">
		<img src="${ctxStatic}/order/images/head_back.jpg">
		<div class="head-content">
			<div class="logo">
				<img src="${ctxStatic}/order/images/head_logo.png">
			</div>
		</div>
	...
	<div class="pnr-content">
		<div class="pnr-content-left">
			<div class="order">
				<div class="orderlist">
					<p>国际机票订单查询<img src="${ctxStatic}/order/images/orderdrop.png"></p>
					<ul>
						<li><a href="<%=request.getContextPath()%>/a/order/supplier/tbTicketorderDetail/list" target="rightFrame" class="clickulli">国际订单查询</a></li>
						<li><a href="<%=request.getContextPath()%>/a/refundsheetdetail/supplier/refundsheetDetail" target="rightFrame">国际退票订单</a></li>
						<li><a href="<%=request.getContextPath()%>/a/order/supplier/voidsheetDetail" target="rightFrame">国际废票订单</a></li>
						<li><a href="<%=request.getContextPath()%>/a/order/supplier/endorsesheetDetail/list1" target="rightFrame">国际改签订单</a></li>
					</ul>
				</div>
				<div class="orderlist">
					<p>国际机票订单详情-PNR<img src="${ctxStatic}/order/images/orderdrop.png"></p>
					<ul class="ordernone">
						<li><a href="detailsuc.html" target="rightFrame">生成订单成功</a></li>	
						<li><a href="javascript:void(0);">供应商价格核实</a></li>
						<li><a href="javascript:void(0);">供应商未核实</a></li>
						<li><a href="javascript:void(0);">供应商确认价格</a></li>
						<li>
							<p>订单成功支付完成<img src="${ctxStatic}/order/images/orderdrop.png"></p>
							<ul class="ordernone">
				...
				<div class="orderlist">
					<p>国际订单支付信息<img src="${ctxStatic}/order/images/orderdrop.png"></p>
					<ul class="ordernone">
						<li><a href="javascript:void(0);">国际订单查询</a></li>
					</ul>
				</div>
				<div class="orderlist">
					<p>国际订单出票完成<img src="${ctxStatic}/order/images/orderdrop.png"></p>
					<ul class="ordernone">
						<li><a href="javascript:void(0);">国际订单查询</a></li>
					</ul>
				</div>
				<div class="orderlist">
					<p>订单申请退票确认<img src="${ctxStatic}/order/images/orderdrop.png"></p>
					<ul class="ordernone">
						<li><a href="javascript:void(0);">国际订单查询</a></li>
					</ul>
				</div>
				<div class="orderlist">
					<p>国际订单退票信息<img src="${ctxStatic}/order/images/orderdrop.png"></p>
					<ul class="ordernone">
						<li><a href="javascript:void(0);">国际订单查询</a></li>
					</ul>
				</div>
				<div class="orderlist">
					<p>国际订单废票信息<img src="${ctxStatic}/order/images/orderdrop.png"></p>
					<ul class="ordernone">
						<li><a href="javascript:void(0);">国际订单查询</a></li>
					</ul>
				</div>
				<div class="orderlist">
					<p>国际订单改签信息<img src="${ctxStatic}/order/images/orderdrop.png"></p>
					<ul class="ordernone">
						<li><a href="javascript:void(0);">国际订单查询</a></li>
					</ul>
				</div>
