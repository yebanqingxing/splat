	...
	<div class="ordercon">
		<div class="orderconhead">
			<ul class="orderconul clear">
				...
				<c:if test="${voidsheetDetail.currentStatus  == '3' }">拒绝废票</c:if>
		...
		<div class="orderconbom clear">
			<div class="orderconbom-left fl">
				...
				<ul class="clear">
					...
					<li class="liwid">废票价：${voidsheetDetail.supplierTotSettlementPrice }</li>
...
<!-- 				<button class="addquery butwid">操作历史</button> -->
				<a href="${ctx }/order/supplier/voidsheetDetail/findVoidsheetDetail?voidsheetNo=${voidsheetDetail.voidsheetNo }"><button class="addquery butwid">详情信息</button></a>
			</div>
		</div>
	</div>
</c:forEach>
