...
// 	});
	function page(n,s){
		...
		var pageSize=s;
		$.post(
		'${ctx}/order/supplier/tbTicketorderDetail/list?number='+Math.random(),
...
<div class="orderkli">
	...
	<table border="0">
          ...
          <td id="td" class="tableclcik"><a href='javascript:;' onclick="searchAll(this)">全部</a></td>
            <td><a href="javascript:;" onclick="findCurrentStatus(this,'1')">审核订单(${currentStatus['1']})</a></td>
            ...
            <td><a href="javascript:;" onclick="findCurrentStatus(this,'6')">全额退款(${currentStatus['6']})</a></td>
