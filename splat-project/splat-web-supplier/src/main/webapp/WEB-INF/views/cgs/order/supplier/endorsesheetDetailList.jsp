...
$(function(){
	...
	function page(n,s){
		...
		var pageSize=s;
		$.post(
				'${ctx}/order/supplier/endorsesheetDetail/list1?number='+Math.random(),
		...
		<table border="0">
		  <tr>
		    <td id="td" class="tableclcik"><a href="javascript:;" onclick="searchAll(this);">全部</a></td>
		        ...
		        <td><a href="javascript:;" onclick="findPayStatus(this,'1')">等待确认和支付(${payStatusCount['1']})</a></td> 
		    	<td><a href="javascript:;" onclick="findCurrentStatus(this,'2')">等待改签(${currentStatus['2']})</a></td> 
		    	<td><a href="javascript:;" onclick="findCurrentStatus(this,'4')">改签完成(${currentStatus['4']})</a></td> 
