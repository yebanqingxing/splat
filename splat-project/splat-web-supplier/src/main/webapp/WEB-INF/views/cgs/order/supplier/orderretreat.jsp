...
$(function(){
	...
	function page(n,s){
		...
		var pageSize=s;
		$.post(
				'${ctx}/refundsheetdetail/supplier/refundsheetDetail?number='+Math.random(),
...
<body>
<div class="addpolicy">
	<img src="${ctxStatic}/order/images/orderretreat.png" style="margin-top:10px;">
	<p>国际退票订单</p>
</div>
<!-- 总则编码 -->
<div class="query">
...
<!-- 订单的状态 隐藏域 -->
<input type="hidden" id="hid_refundsheetStatus" name="hid_refundsheetStatus" value=""/>
...
<div class="orderkli">
	<div class="orderretreat">
		<table border="0">
          ...
          <td><a href="javascript:;" onclick="findCurrentStatus(this,'1');">审核退票(${currentStatus['1']})</a></td>
          <td><a href="javascript:;" onclick="findCurrentStatus(this,'4');">等待确认(${currentStatus['4'] })</a></td>
          <td><a href="javascript:;" onclick="findCurrentStatus(this,'3');">等待退票(${currentStatus['3'] })</a></td>
          <td><a href="javascript:;" onclick="findCurrentStatus(this,'5');">退票完成(${currentStatus['5'] })</a></td>
          <td><a href="javascript:;" onclick="findOrderStatus(this,'4');">异常订单(${statusCount['4'] })</a></td>
          <td><a href="javascript:;" onclick="findCurrentStatus(this,'2');">审核拒绝(${currentStatus['2']})</a></td>
          <td><a href="javascript:;" onclick="findOrderStatus(this,'2');">退票取消(${statusCount['2'] })</a></td>
          </tr>    
		</table>
	</div>
