		...
		<div class="orderconhead">
			<ul class="orderconul clear">
				...
				<li>操作状态：<span class="redreset">
					<c:if test="${refundsheetDetail.currentStatus == '1' }">等待审核</c:if>
...
<!-- 				<button class="addquery butwid">操作历史</button> -->
				<a href="${ctx }/refundsheetdetail/supplier/refundsheetDetail/findRefundsheetDetail?refundsheetNo=${refundsheetDetail.refundsheetNo }"><button class="addquery butwid">详情信息</button></a>
			</div>
		</div>
	</div>	
</c:forEach>
