...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/general/css/policy.css">
<script type="text/javascript" src="<%=request.getContextPath()%>/static/general/js/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/static/general/js/addpolicy.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery-1.4.2.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/j.suggest.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/j.dimensions.js"></script>
...
<body>
		<div class="addpolicy">
	<img src="<%=request.getContextPath()%>/images/xiudeil.png">
	<p>详细修改</p>
</div>
<!-- 作用域 -->
...
<%-- 					<img src="<%=request.getContextPath()%>/images/radio2.png" > --%>
		...
		<div class="effectcon1 fl">
			...
			<div class="effectli">
				<label class="checkradio">
				<input type="radio" name="goDestinationChoice" value="1" <c:if test="${generalRules.goDestinationChoice == 0}">checked="checked"</c:if>/>
<%-- 					<img src="<%=request.getContextPath()%>/images/radio1.png" > --%>
...
<div class="policy-effect clear">
	...
	<div class="effect-content">
		...
		<div class="button-check">
			<img src="<%=request.getContextPath()%>/static/general/images/addplo.png">
			<p><input type="submit" style="background:#c41213;border:0;float:left;margin-top:7px; marfont-size:16px;color:#FFF;" value="修改总则"/></p>
		</div>
	</form>
	</div>
</div>
