		...
		<div class="ordercon">
			<div class="orderconhead">
				<ul class="orderconul clear">
					...
					<c:if test="${detail.refundsheetStatus == '1' }">已提交</c:if>
					<c:if test="${detail.refundsheetStatus == '2' }">已拒单</c:if>
					<c:if test="${detail.refundsheetStatus == '3' }">已核单</c:if>
					<c:if test="${detail.refundsheetStatus == '4' }">已退票</c:if>
					<c:if test="${detail.refundsheetStatus == '5' }">已删除</c:if>
					</span></li>
					<li class="ordermargin">|</li>
...
<div class="aircraft">
	...
	<div class="rosizehead">
		<textarea></textarea>
		<div class="butbotom">
			<button ><a href="<%=request.getContextPath()%>/a/refundsheetdetail/supplier/refundsheetDetail/editRefundsheetStatus?refundsheetStatus=3&refundsheetNo=${detail.refundsheetNo }">确认退票</a></button>
			<button ><a href="<%=request.getContextPath()%>/a/refundsheetdetail/supplier/refundsheetDetail/editRefundsheetStatus?refundsheetStatus=2&refundsheetNo=${detail.refundsheetNo }"">拒绝退票</a></button>
		</div>	
	</div>
</div>
</body>
