...
<div class="query clear">
	<div class="queryinter">
		...
		<input type="text" name="policyName" id="policyName"  value="${tbPolicyRules.policyName}" class="querycode" onkeyup="this.value=this.value.replace(/[^\u4E00-\u9FA5\d\A-Za-z]/g,'');"><span class="redreset">∗</span>
...
<div class="passnger clear">
	...
	<div class="queryinter" style="margin-top: 20px;">
		...
		<label><input type="checkbox" id="effectil1" class="checkeffect" ${fn:indexOf(tbPolicyRules.passagerPid, '1') != -1 ?  'checked' : '' }  name="passagerPid" value="1">
...
<%-- 		<img src="${ctxStatic}/images/interno.png" class="addimg"> --%>
	...
	<div class="clear">
		<div class="button-detail fl" style="margin-left: 148px;" onclick="add()">
			<img src="${ctxStatic}/images/xiudeil.png">
			<p><input type="button"  style="background:#c41213;border:0;float:left;margin-top:7px; marfont-size:16px;color:#FFF;" value="修改"/></p>
		</div>
		<div class="button-detail fl" style="margin-left: 0;" onclick="copy(${tbPolicyRules.id})">
...
function copy(id){
	window.location.href="${ctx}/policyrules/policyRules/toCopy?id="+id;
}
</script>
</body>
</html>