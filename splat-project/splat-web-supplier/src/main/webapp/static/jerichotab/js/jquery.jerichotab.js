    ...
    buildIFrame: function(src) {
        ...
        return this.each(function() {
            ...
            $('#' + jerichotabiframe).addEvent('load', function() {
				...
				if($("#left").width()<50){
					 var temp = $('.page-sidebar .sidebar-toggler')[jerichotabiframe.replace("jerichotabiframe_","")];
					 if(temp)temp.click();
				}
//                var _that = this;
//                var parentHeight = (window.winClientHeight?window.winClientHeight:$(document).height())-99;
//                var ifrHeight = $(_that).contents().find("body").height()+21;
//                $(_that).contents().find("html").css("overflowY","hidden");
//                var ifrHeight2 = ifrHeight;
//                if(parentHeight>ifrHeight){
//                	ifrHeight = parentHeight;
//                }else{
//                	ifrHeight = ifrHeight+70;
//                }
//			  $(window.parent.document).find('#' + jerichotabiframe).height(ifrHeight2);
			  //$(".page-content").height(ifrHeight);
//			  $(".page-content").css("height",ifrHeight+"px");
//			  $("#jerichotab_contentholder").height(ifrHeight2); 
    ...
    loadData: function(flag) {
        return this.each(function() {
        	$('.jericho_tab .tab_selected').css('background-color', '#fff'/*$('body').css('background-color')*/);
            ...
            if (holder.length == 0) {
                ...
                /*if($(_that).contents().find("form")!= null && "/splat-web-admin/a/sys/role/save" == $(_that).contents().find("form").attr("action") ){*/
               
    			//var h = ifram.height();
    			//$(ifram).contents().find("form").height(h);
               
    			//$(parent.document.getElementById("right")).height();
	          	//var h = $("").contents().find("form").height();
	          	//ifrHeight2 = h;
               /* }*/
                load(holder);
                ...
                if($("#left").width()<50){
           		 var temp = $('.page-sidebar .sidebar-toggler')[$(this).attr("id").replace("jerichotab_","")]
           		 if(temp)temp.click();
                }
//                var ifrmId = "jerichotabiframe_"+$(this).attr("id").replace("jerichotab_","");
//                var parentHeight = (window.winClientHeight?window.winClientHeight:$(document).height())-99;
//                var ifrHeight = $("#"+ifrmId).contents().find("body").height()+10;
//                var ifrHeight2 = ifrHeight;
//                if(parentHeight>ifrHeight){
//                	ifrHeight = parentHeight;
//                }else{
//                	ifrHeight = ifrHeight+70;
//                }
//                $(window.parent.document).find('#' + ifrmId).height(ifrHeight2);
                //$(".page-content").height(ifrHeight);
//                $(".page-content").css("height",ifrHeight+"px");
//                $("#jerichotab_contentholder").height(ifrHeight2);
            }
            ...
            switch ($.fn.jerichoTab.loader) {
                ...
                case 'righttag':
                    ...
                    if ($('#jerichotab_contentholder>.righttag').length == 0){
                        $('<di class="loading-back righttag">'+
                        		'<div class="loading-con">'+
            					'<img src="/splat-web-supplier/static/images/loading.gif">'+
            					'<span>努力加载中，请稍后...</span>'+
            				'</div>'+
            			'</div>').appendTo($(this));
                    }
